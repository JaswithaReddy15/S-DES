...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 13 20:36:04 2020

@author: jaswithareddy

The decryption is almost same as encryption. We only swap Key1 with Key2 to decrypt cipher key.
...
def funcXOR8(EP,k): # EP xor with k1
    xor=[]
    for i in range(8):
        if EP[i]==k[i]:
            xor.append('0')
...
if __name__=='__main__':
    ...
    inpkey=[]
    k=input(("Enter a 8 bit cipher key in binary: "))
    ...
    if flag==1:
        ...
        if k2flag==1:
            ...
            if k1flag==1:
                ...
                print("Decryption => Plain Key: ",end='')
